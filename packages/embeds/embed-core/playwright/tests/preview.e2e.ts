...
test.describe("Preview", () => {
  test("Preview - embed-core should load if correct embedLibUrl is provided", async ({ page }) => {
    await page.goto(
      "http://localhost:7502/embed/preview.html?embedLibUrl=http://localhost:7502/embed/embed.js&bookerUrl=http://localhost:7502&calLink=pro/30min"
    );
  ...
  test("Preview - embed-core should load from embedLibUrl", async ({ page }) => {
    ...
    page.goto(
      "http://localhost:7502/embed/preview.html?embedLibUrl=http://localhost:7502/embed/embed-not-found.js&bookerUrl=http://localhost:7502&calLink=pro/30min"
    );
    ...
    expect(failedRequestUrl).toBe("http://localhost:7502/embed/embed-not-found.js");
  });
});
