...
1. Open a browser to [http://localhost:7502](http://localhost:7502) and login with your just created, first user.
...
Be sure to set the environment variable `NEXTAUTH_URL` to the correct value. If you are running locally, as the documentation within `.env.example` mentions, the value should be `http://localhost:7502`.
