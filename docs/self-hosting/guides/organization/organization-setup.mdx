...
```bash
NEXT_PUBLIC_WEBAPP_URL=http://app.cal.local:7502
NEXT_PUBLIC_WEBSITE_URL=http://app.cal.local:7502
NEXTAUTH_URL=http://app.cal.local:7502
...
2. Visit `http://app.cal.local:7502/settings/organizations/new`
...
<Note>
After creating the organization, you'll be moved inside it and all existing Cal.com links will redirect to the organization URL (e.g., `yourdomain.cal.local:7502`).
</Note>
...
```
http://myorg.cal.local:7502/{CAL_LINK}
```
